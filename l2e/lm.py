"""
Take it from transformer and Yuhui's github
"""
...
class TransformerLM(nn.Module):
    """
    A standard Decoder structure.

    decoder can be passed in as Transformer or LSTM
    """
    ...
    def compute_lm_loss(self, s_h, s_y, s_loss_mask):
        ...
        # config['n_words'] is the vocab_size
